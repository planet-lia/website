      ...
      <div>
        ...
        <div id="cont-brackets-page">
          <div className="cont-brackets">
            <Bracket battleId={1} player1="grekiki1234" player2="aleksgorica"/>
            <Bracket battleId={2} player1="neverlucky" player2="3Head"/>
            <Bracket battleId={3} player1="ailia" player2="Cmaster"/>
            <Bracket battleId={4} player1="Bubberducky" player2="Gnorts"/>
            ...
            <Bracket battleId={5} player1="root" player2="HocemPS4"/>
            <Bracket battleId={6} player1="HugeSmile" player2="Shaggy"/>
            <Bracket battleId={7} player1="Sever" player2="mmartinnee"/>
            <Bracket battleId={8} player1="PrekaljeniLisjak" player2="TheKing"/>
          </div>
        </div>
      </div>
    )
